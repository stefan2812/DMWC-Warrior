...
function Warrior.Settings()
	...
	UI.AddHeader("Helper")
	UI.AddToggle("Auto Mining", "Auto Mines when close to Node and not in Combat", false)
	UI.AddToggle("Auto Herb", "Auto Herbs when close to Node and not in Combat", false)
	UI.AddHeader("Opener")
